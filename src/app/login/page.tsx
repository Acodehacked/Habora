    ...
    <main className="auth-page">
      <section className="auth-card">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <button className="primary-button auth-submit" disabled={loading}>{loading ? "Working..." : "Sign in"}<ArrowRight size={16} /></button>
        </form>
        <button className="auth-signup" onClick={handleSignUp} disabled={loading}>Create a new account</button>
      </section>
    </main>
  );
}